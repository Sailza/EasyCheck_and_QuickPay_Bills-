        ...
        if(e.getSource()==create){
            ...
            try{
                ...
                if(loginAsChoice.equals("Admin")){
                    query_signup = "insert into  Signup value('"+smeter+"', '"+susername+"', '"+sname+"', '"+spass+"', '"+sloginAs+"')";

                }else{
                    query_signup = "Update Signup set username = '"+susername+"', password = '"+spass+"', usertype = '"+sloginAs+"' where meter_no ='"+smeter+"'";
                }
